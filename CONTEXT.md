# CONTEXT.md — Who Luca Is (read this first in every chat)

## Basics
- Luca, 18+, lives in Atlanta, GA. US citizen; also holds Belgian and Tongan passports.
  Open to placement anywhere in the US.
- Availability until July 17: 20–35 hours/week.

## Learning profile (shapes HOW to work with him, and WHAT he's building)
- **Dyslexia** and **ADHD**, formally diagnosed. Had an **IEP through City Schools of
  Decatur, GA**. Executive functioning — task initiation, sequencing, holding a plan in
  his head — is his biggest challenge.
- Learns best audio-visually and by doing. Long dense text is a barrier.
- Zero coding experience as of July 2026. Determined, coachable, hands-on.
- His learning profile is not a footnote: it is the origin story of the project.
  He is building the tool that would have helped him.

## The full-circle Märchen Sagen story (the spine of the application)
- **As a child (~10 years old), Luca ATTENDED Märchen Sagen Academy** — the same
  nonprofit he now works for. His kid-era videos are still on YouTube:
  - https://youtu.be/oyZXlmdwTZc — young Luca: "this is Luca and I've been in
    Märchen Sagen for about one week... I've been learning green screen, lights, camera"
...
- **Today he WORKS there**, guiding kids ages 6–12 through the same craft:
  ...
  - **Summer K.A.M.P. Week 1 — AI Filmmaking**, where Luca guided kids using AI
    tools in their filmmaking: https://www.youtube.com/watch?v=bItqx9UdWQE
...
- Competitive swimmer for the **Tonga national swim team** — discipline, performing
  under pressure, representing a community, cross-cultural fluency.
- Fashion model with **Crawford Models** (crawfordmodels.com) — professionalism,
  taking direction, comfort in front of people and cameras.
- Family support: his dad Tom works at Cutover (cutover.com), an enterprise software
  firm, and provides daily accountability plus access to engineer-advisors.

## Assets status (as of July 4, 2026)
- LinkedIn: exists, needs polish (REQUIRED field on the application).
- Resume: exists, needs polish (REQUIRED upload).
- GitHub: does not exist yet — created on Day 1 per MASTER_PLAN.md.
- AI Fluency + Claude 101 certificates: not yet earned — top priority, proof required.
