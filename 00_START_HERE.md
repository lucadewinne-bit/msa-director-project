# START HERE — Setting Up This Project on Luca's Claude Account

This folder is the complete handoff package for Luca's Claude Corps application project.
Conversations cannot be transferred between Claude accounts — and they don't need to be.
Everything that matters lives in these files. Follow these steps once, in order.
...
3. **On the Project page, find the "Instructions" section** (the + next to it /
   ...
   **and paste this block:**
   ...
   > Luca has dyslexia and ADHD; executive functioning is his biggest challenge.
   > Always: one next action at a time, short concrete steps, plain language, no walls
   > of text unless asked. Open every chat by asking what he got done and how much time
   > he has right now, then give the single best next action for that time. Track state
   > in MASTER_PLAN.md and DECISIONS.md — when they need updating, output the full
   > updated file so Luca can replace it in project knowledge and in the GitHub repo.
   > Be honest; push back on scope creep. Flag essay material when you see it.

4. **Start the first chat** with exactly this message:
   `Read PHASE1_PROMPT.md and begin.`

## Keeping the files alive (the integrity system)
...
- **Cutover engineers** are advisors and reviewers ONLY. They never touch the keyboard.
  (The application asks what Luca built "on your own," and interviews will probe it.)
